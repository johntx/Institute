...
<div class="panel-body">
	...
	<table class="sch">
		<tbody>
			<tr>
				<th colspan="7">HORARIO {{$inscription->group->startclass->career->nombre}} {{$inscription->group->turno}}</th>
			</tr>
			<tr>
